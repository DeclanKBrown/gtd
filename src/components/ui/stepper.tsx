    ...
    return (
      <div
        ...
        className={cn(
          ...
          isCompletedStep &&
            '[&:not(:last-child)]:after:bg-white [&:not(:last-child)]:after:data-[invalid=true]:bg-destructive',
      ...
      >
        <div
          ...
          className={cn(
            ...
            'flex items-center',
            variant === 'simple' &&
              'border-s-[3px] py-2 ps-3 data-[active=true]:border-white',
    ...
    return (
      <div
        ...
        className={cn(
          ...
          variant === 'circles-alt' &&
            'flex-1 flex-col justify-start [&:not(:last-child)]:after:relative [&:not(:last-child)]:after:end-[50%] [&:not(:last-child)]:after:start-[50%] [&:not(:last-child)]:after:top-[calc(var(--step-icon-size)/2)] [&:not(:last-child)]:after:order-[-1] [&:not(:last-child)]:after:w-[calc((100%-var(--step-icon-size))-(var(--step-gap)*2))]',
          variant === 'circles' &&
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        'data-[active=true]:border-white data-[active=true]:bg-white data-[active=true]:text-primary-foreground dark:data-[active=true]:text-primary',
        'data-[current=true]:border-white data-[current=true]:bg-secondary',
        'data-[invalid=true]:!border-destructive data-[invalid=true]:!bg-destructive data-[invalid=true]:!text-primary-foreground dark:data-[invalid=true]:!text-primary',
